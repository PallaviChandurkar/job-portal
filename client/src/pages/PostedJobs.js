        ...
        },
        {
            ...
            render: (text, data) => {
                return <div className="flex">
                    <EditOutlined style={{fontSize: 20}} className="mr-2" onClick={() => { history.push(`/editjob/${data.completeJobData._id}`) }} />
    ...
    return (
        <div>
            <DefaultLayout>
                ...
                <Modal title="Applied Candidates List" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} width={800}>
                    <CandidatesList/>
                </Modal>
            </DefaultLayout>
        </div>
